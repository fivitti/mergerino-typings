...
declare module 'mergerino' {
     ...
     */
    export type Merge<S extends object> = (source: S, ...patches: ReadonlyArray<MultipleTopLevelPatch<S>>) => S;
     ...
     * Since falsy patches are ignored.
     */
    export default function merge<S extends object>(source: S, ...patches: ReadonlyArray<MultipleTopLevelPatch<S>>): S;
}